...
export default function Home() {
  ...
  useEffect(() => {
    const fetchSongs = async () => {
      try {
        const loveSongsData = await getLoveSong();
        const allSongsData = await getSongs();
        const hollywoodSongsData = await getHollywoodSongs();
        const FriendshipSongData = await getFrienshipSong();
        const SistserSongData = await getSisterSong();
        const SadSongsData = await getSadSong();
        const RapSongsData = await getRapSongs();
        const MalayalamSongData = await getMalayalamSongs();
        const HindiSongsData = await getHindiSongs();
        const TeleguSongsData = await getTeleguSongs();
        const OldSongsData = await getOldSongs();
        const ChristmasSongsData = await getChristmasSongs();
        const ItemSongsData = await getItemSongs();
