...
const supabase = createClient('https://hmlpkncszudwmcswmstp.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhtbHBrbmNzenVkd21jc3dtc3RwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwMzkzMzA1NywiZXhwIjoyMDE5NTA5MDU3fQ.WNCkTFHhJoEnIWu_lO4-77lmARSczHgy9_bI2S3JC88');
